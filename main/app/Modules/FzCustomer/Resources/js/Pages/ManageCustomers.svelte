                    ...
                    <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>4, Tiger way, nixon avenue, Earth.</td>
                                <td>
                                    <span>#45,000 </span>
                                    <a href="#">
                                        <i class="icon-feather-file-text" data-placement="top" data-toggle="tooltip" data-original-title="View Credit History"></i>
                                    </a>
                                </td>
                                <td>Flagged</td>
                                <td class="row-actions remove-center">
                                    <a href="purchase_order.html" data-placement="top" data-toggle="tooltip" data-original-title="New Purchase Order">
                                    ...
                                    <a href="#" data-placement="top" data-toggle="tooltip" data-original-title="Edit Data">
                                        <i class="icon-feather-settings"></i>
                                    </a>
                                    <a class="danger" data-target="#deleteCustomerModal" data-toggle="modal" href="#">
                                        <i class="icon-feather-trash-2" data-placement="top" data-toggle="tooltip" data-original-title="Delete customer"></i>
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>+2348000000000</td>
                                <td>Kelly@Yaw.com</td>
                                <td>32, Social avenue, north district, Earth.</td>
                                <td>
                                    <span>#45,000 </span>
                                    <a href="#">
                                        <i class="icon-feather-file-text" data-placement="top" data-toggle="tooltip" data-original-title="View Credit History"></i>
    ...
    <div class="modal-dialog modal-centered" role="document">
        <div class="modal-content text-center"><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span class="close-label">Close</span><span class="os-icon os-icon-close"></span></button>
            ...
            <div class="onboarding-content with-gradient">
                ...
                <a class="btn btn-danger btn-md" href="#"><i class="icon-feather-trash-2"></i><span> Delete Customer</span></a>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Enter full name..." type="text" required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="">Email Address</label>
                                <input class="form-control" placeholder="Enter email address..." type="email" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Enter mobile number..." type="number" required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Enter residential address..." type="text" required>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="">Credit Limit</label>
                                <input class="form-control" placeholder="Enter credit limit..." type="number" required>
                            </div>
                        </div>
                    </div>
