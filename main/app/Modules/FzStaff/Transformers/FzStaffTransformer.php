...
namespace App\Modules\FzStaff\Transformers;

use App\Modules\FzStaff\Models\FzStaff;
use App\Modules\FzStaff\Models\Transaction;

class FzStaffTransformer
{
  ...
  public function transform(FzStaff $user)
  {
    return [
  ...
  public function transformBasic(FzStaff $user)
  {
    return [
      'email' => (string)$user->email,
      'first_name' => (string)$user->first_name,
  ...
  public function transformForFzStaff(FzStaff $user)
  {
