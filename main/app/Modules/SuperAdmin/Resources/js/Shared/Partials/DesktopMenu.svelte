...
<div class="menu-w color-scheme-light color-style-transparent menu-position-side menu-side-left menu-layout-compact sub-menu-style-over sub-menu-color-bright selected-menu-color-light menu-activated-on-hover menu-has-selected-link">
  ...
  <div class="logo-w">
    <a class="logo" href="index.html">
      ...
      <div class="logo-label">FZ Oil</div>
    </a>
  </div>
  ...
  <ul class="main-menu">
      ...
      {:else if route_cont.length > 1}
        <li class="selected has-sub-menu">
          <a href="#">
            <div class="icon-w">
              <div class="os-icon os-icon-layout"></div>
            </div><span>{route_name}</span>
          </a>
          <div class="sub-menu-w">
            <div class="sub-menu-header">{route_name}</div>
    ...
    <li class="selected">
      ...
      <a use:inertia="{{method: 'post', preserveState: false, preserveScroll:false }}"  href={route('auth.logout')}>
