...
')
     ...
     */ 
         ...
         * 
         *
         * @see \Wewowweb\LaravelSveltePreset\LaravelSveltePresetServiceProvider::boot()
         * @param mixed $command
         * @static 
         */ 
        public static function svelte($command)
        {
                        return \Illuminate\Console\Command::svelte($command);
        }
